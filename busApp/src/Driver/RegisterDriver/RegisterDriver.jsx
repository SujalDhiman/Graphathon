    ...
    <div className="bg-[#F5FDFF] h-[100vh] w-[35%] flex flex-col items-center">
        ...
        {page === "Register"?(
            ...
            <div className="flex flex-col items-center space-y-[4vh]">
                ...
                {busNumber==""?(
                <label htmlFor="busNumber" className="ml-[8px] transform transition-all absolute top-0 left-0 h-full flex items-center pl-2 text-lg group-focus-within:text-xs peer-valid:text-xs group-focus-within:h-1/2 peer-valid:h-1/2 group-focus-within:-translate-y-[2px] peer-valid:-translate-y-full group-focus-within:pl-0 peer-valid:pl-0">Bus Number</label>):(<label htmlFor="busNumber" className="hidden">Bus Number</label>)}
                <BusNumberSVG />
                </div>
                ...
                {busNumberPlate==""?(
                <label htmlFor="busNumberPlate" className="ml-[8px] transform transition-all absolute top-0 left-0 h-full flex items-center pl-2 text-lg group-focus-within:text-xs peer-valid:text-xs group-focus-within:h-1/2 peer-valid:h-1/2 group-focus-within:-translate-y-[2px] peer-valid:-translate-y-full group-focus-within:pl-0 peer-valid:pl-0">Registration Number</label>):(<label htmlFor="busNumber" className="hidden">Registration Number</label>)}
                <BusNumberPlate />
                </div>
                ...
                {name==""?(
                <label htmlFor="name" className="ml-[8px] transform transition-all absolute top-0 left-0 h-full flex items-center pl-2 text-lg group-focus-within:text-xs peer-valid:text-xs group-focus-within:h-1/2 peer-valid:h-1/2 group-focus-within:-translate-y-[2px] peer-valid:-translate-y-full group-focus-within:pl-0 peer-valid:pl-0">Name</label>):(<label htmlFor="name" className="hidden">Name</label>)}
                <UserSVG />
                </div>
                ...
                {contact==""?(
                <label htmlFor="contact" className="ml-[8px] transform transition-all absolute top-0 left-0 h-full flex items-center pl-2 text-lg group-focus-within:text-xs peer-valid:text-xs group-focus-within:h-1/2 peer-valid:h-1/2 group-focus-within:-translate-y-[2px] peer-valid:-translate-y-full group-focus-within:pl-0 peer-valid:pl-0">Contact Number</label>):(<label htmlFor="name" className="hidden">Contact Number</label>)}
                <ContactSVG />
                </div>    
